...
int MyMsg::getSourceId() const
{
    return this->sourceId;
}

void MyMsg::setSourceId(int sourceId)
{
    this->sourceId = sourceId;
}

int MyMsg::getDestId() const
{
    return this->destId;
}

void MyMsg::setDestId(int destId)
{
    this->destId = destId;
}

const char * MyMsg::getPacketType() const
{
    return this->packetType.c_str();
}

void MyMsg::setPacketType(const char * packetType)
{
    this->packetType = packetType;
}

int MyMsg::getPacketId() const
{
    return this->packetId;
}

void MyMsg::setPacketId(int packetId)
{
...
MyMsgDescriptor::MyMsgDescriptor() : omnetpp::cClassDescriptor("MyMsg", "omnetpp::cPacket")
{
...
std::string MyMsgDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 2: return oppstring2string(pp->getPacketType());
...
bool MyMsgDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 2: pp->setPacketType((value)); return true;
